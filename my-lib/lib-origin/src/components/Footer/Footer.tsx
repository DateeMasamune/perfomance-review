...
const Footer: FC<IFooter> = ({ classNameNameName }) => {
    return (
        <div className={`pg-footer ${classNameNameName}`}>
                ...
                <div className="footer-content">
                    <div className="footer-content-column">
                        <div className="footer-logo">
                            <a className="footer-logo-link link" href="#">
                        ...
                        <div className="footer-menu">
                            ...
                            <ul id="menu-get-started" className="footer-menu-list">
                                ...
                                <li className="menu-item menu-item-type-post_type menu-item-object-product">
                                    <a className='link' href="#">Installation</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="footer-menu">
                            ...
                            <ul id="menu-quick-links" className="footer-menu-list">
                                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                                    <a className='link' target="_blank" rel="noopener noreferrer" href="#">Support Center</a>
                                </li>
                                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                                    <a className='link' target="_blank" rel="noopener noreferrer" href="#">Service Status</a>
                                </li>
                                <li className="menu-item menu-item-type-post_type menu-item-object-page">
                                ...
                                <li className="menu-item menu-item-type-post_type_archive menu-item-object-customer">
                                    <a className='link' href="#">Customers</a></li>
                                <li className="menu-item menu-item-type-post_type menu-item-object-page">
                    ...
                    <div className="footer-content-column">
                        <div className="footer-call-to-action">
                            ...
                            <a className="footer-call-to-action-button button link" href="#" target="_self"> Get in Touch </a>
                        </div>
                        <div className="footer-call-to-action">
                    ...
                    <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
                        ...
                        <a className="footer-social-link linkedin link" href="#" target="_blank">
                        ...
                        <a className="footer-social-link twitter link" href="#" target="_blank">
                        ...
                        <a className="footer-social-link youtube link" href="#" target="_blank">
                        ...
                        <a className="footer-social-link github link" href="#" target="_blank">
                ...
                <div className="footer-copyright">
                    <div className="footer-copyright-wrapper">
                        <p className="footer-copyright-text">
                            <a className="footer-copyright-link link" href="#" target="_self"> ©2020. | Designed By: Pooja Nahelia. | All rights reserved. </a>
                        </p>
                    </div>
                </div>
            </footer>
